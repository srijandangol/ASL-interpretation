...
while True:
    ...
    if interrupt & 0xFF == ord('0'):
        cv2.imwrite(directory + '0/' + str(count['zero'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('a'):
        cv2.imwrite(directory + 'A/' + str(count['a'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('b'):
        cv2.imwrite(directory + 'B/' + str(count['b'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('c'):
        cv2.imwrite(directory + 'C/' + str(count['c'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('d'):
        cv2.imwrite(directory + 'D/' + str(count['d'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('e'):
        cv2.imwrite(directory + 'E/' + str(count['e'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('f'):
        cv2.imwrite(directory + 'F/' + str(count['f'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('g'):
        cv2.imwrite(directory + 'G/' + str(count['g'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('h'):
        cv2.imwrite(directory + 'H/' + str(count['h'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('i'):
        cv2.imwrite(directory + 'I/' + str(count['i'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('j'):
        cv2.imwrite(directory + 'J/' + str(count['j'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('k'):
        cv2.imwrite(directory + 'K/' + str(count['k'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('l'):
        cv2.imwrite(directory + 'L/' + str(count['l'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('m'):
        cv2.imwrite(directory + 'M/' + str(count['m'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('n'):
        cv2.imwrite(directory + 'N/' + str(count['n'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('o'):
        cv2.imwrite(directory + 'O/' + str(count['o'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('p'):
        cv2.imwrite(directory + 'P/' + str(count['p'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('q'):
        cv2.imwrite(directory + 'Q/' + str(count['q'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('r'):
        cv2.imwrite(directory + 'R/' + str(count['r'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('s'):
        cv2.imwrite(directory + 'S/' + str(count['s'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('t'):
        cv2.imwrite(directory + 'T/' + str(count['t'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('u'):
        cv2.imwrite(directory + 'U/' + str(count['u'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('v'):
        cv2.imwrite(directory + 'V/' + str(count['v'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('w'):
        cv2.imwrite(directory + 'W/' + str(count['w'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('x'):
        cv2.imwrite(directory + 'X/' + str(count['x' + 700]) + '.jpg', test_image)

    if interrupt & 0xFF == ord('y'):
        cv2.imwrite(directory + 'Y/' + str(count['y'] + 700) + '.jpg', test_image)

    if interrupt & 0xFF == ord('z'):
        cv2.imwrite(directory + 'Z/' + str(count['z'] + 700) + '.jpg', test_image)
